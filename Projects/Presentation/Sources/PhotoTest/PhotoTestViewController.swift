...
final class PhotoTestViewController: BaseViewController {
    ...
    private func setupView() {
        ...
        test1Button.setTitleColor(Theme.textPrimary, for: .normal)
        
        test2Button.setTitle("한국 갯수", for: .normal)
        test2Button.setTitleColor(Theme.textPrimary, for: .normal)
        
        test3Button.setTitle("주소 변환", for: .normal)
        test3Button.setTitleColor(Theme.textPrimary, for: .normal)
